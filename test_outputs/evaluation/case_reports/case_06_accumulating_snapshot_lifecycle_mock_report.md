# case_06_accumulating_snapshot_lifecycle (mock)
...
```json
{
  "case_id": "case_06_accumulating_snapshot_lifecycle",
  "overall_score": 98,
  "passed": true,
...
```json
{
  ...
  "checks": [
    ...
    },
    {
      ...
      "score": 100,
      "passed": true,
      "notes": "recommended_grain='one row per order lifecycle process instance (order_id)'"
    },
    {
