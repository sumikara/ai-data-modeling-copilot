# case_10_product_attribute_drift_scd (mock)
...
```json
{
  "case_id": "case_10_product_attribute_drift_scd",
  "overall_score": 96,
  "passed": true,
...
```json
{
  "case_id": "case_10_product_attribute_drift_scd",
  "failure_categories": [
    "ignored_null_or_duplicate_evidence",
...
```json
{
  ...
  "checks": [
    ...
    },
    {
      ...
      "score": 100,
      "passed": true,
      "notes": "recommended_grain='product_id candidate with source caveat'"
    },
    {
